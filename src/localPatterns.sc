patterns:
    ...
    $no = * (не нужен/не могу/неверно/неправильно/не*(верно/правильно)/иначе/неа/ноу/другой/нет/ytn) *
    $refuse = * (не (назову/скажу/чего/хочу)/ни (чего/~какой/как)/никак/никакой/уйди/отстань/отвяжись) *
